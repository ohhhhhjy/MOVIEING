...
/*
   @RequestMapping(value="/Movieing/FCMTest2.mov")
   public String fcmTest(@RequestParam Map map,HttpServletRequest req) throws UnsupportedEncodingException {
	    request.setCharacterEncoding("utf-8");

      System.out.println("fcm들어옴");
