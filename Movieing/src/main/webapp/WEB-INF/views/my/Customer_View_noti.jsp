	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<td scope="col"  style="width: 75%" colspan="5">${selectNotiOne.notiTitle }</td>
		...
		<tbody>
			<tr>
				...
				<td style="width: 25%">${selectNotiOne.notiDate}</td>
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<td scope="col" style="width: 75%"><a href="<c:url value='/Movieing/my/Customer_View.mov?qnaNo=${selectNotiOne.notiNo+1 }'/>">${before}</a></td>
		...
		<tbody>
			<tr>
				...
				<td scope="col" style="width: 75%"><a href="<c:url value='/Movieing/my/Customer_View.mov?qnaNo=${selectNotiOne.notiNo-1 }'/>">${after }</a></td>
			</tr>
