...
<head>
    ...
    <title>PB Dashboard Elements | Bootstrap Admin Theme</title>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">            
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav side-nav">
                    <li><a href="index.html"><i class="glyphicon glyphicon-th"></i> Dashboard</a></li>
                    ...
                    <li class="active"><a href="bootstrap.html"><i class="fa fa-magic"></i> Bootstrap Elements</a></li>
