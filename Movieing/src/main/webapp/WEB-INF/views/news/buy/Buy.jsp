					...
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-9">
								...
								<div class="product-desc" style="color: gray;margin-top:10px;margin-left: 10px">
									<strong>&nbsp;Seoul Independent Film Festival</strong>
									<div class="row">
									<span style="color: gray">시작년도</span><span>19</span>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-12">
								<strong>- 국내 경쟁 독립 영화제</strong> <br>
								<p>극, 실험, 다큐멘터리, 애니메이션 등 다양한 독립영화를 주제, 형식, 길이 구분 없이 공모하여
									시상한다. 또한 별도의 초청 섹션을 통해 독립영화의 다양한 경향을 소개한다.</p>
								<br> <strong>- 교류와 소통, 축제의 영화제</strong> <br>
								<p>동시대의 독립영화인들이 한자리에서 만남으로써 독립영화의 시대정신과 비전을 찾고자 하며, 기성 영화의
									대안이 될 새로운 독립영화를 발굴하고 있다.</p>
								<br> <strong>- 영화제 이후를 고민하는 영화제</strong> <br>
								<p>일회성으로 그치는 영화제의 한계를 극복하기 위해, 순회상영회 인디피크닉, 베스트 컬렉션 DVD 제작,
									온라인 상영회, 독립영화 인터뷰 매거진 NOW 등 다양한 활동을 실천하며 관객을 만나고 있다.</p>
								<br> <strong>- 독립영화의 실질적 제작 배급 활성화</strong> <br>
								<p>일상 사업을 통해 독립영화의 배급 경로를 꾸준히 확장해 왔으며 사전제작 지원과 배급, 마케팅 지원 등
									독립영화의 실질적 제작 유통 활성화에 기여하고자 한다.</p>
								<br> <strong>- 관객과 함께하는 영화제</strong> <br>
								<p>자원활동가와 함께 관객심사단 제도를 도입하여 관객 비평을 활성화하였다. 공식 후원모임 인디당은 독립영화
									관객의 다양한 활동을 지지하는 관객 커뮤니티이다.</p>
								<br>
...
<script>
	...
	var price = parseInt(($('#product-price').text()).replace(',', '').replace(
			'원', ''));
