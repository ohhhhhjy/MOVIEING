		...
		<div class="col-md-3">
			...
			<div class="text-center" style="padding-bottom: 50px">
				<img src="<c:url value='/resources/img/friends/dahee.jpg'/>"
					class="radiusImg" alt="프로필 사진" 
					>
				<h6 style="padding-top: 10px">프로필 사진 바꾸기</h6>
				<input type="file" class="text-center center-block file-upload">
			</div>

			<div class="row">

				<a href="#" class="list-group-item list-group-item-action active">프로필
					편집</a> <a href="#" class="list-group-item list-group-item-action">비밀번호
					설정</a> <a href="#" class="list-group-item list-group-item-action">공개범위
					설정</a> <a href="#" class="list-group-item list-group-item-action">알림
					메시지</a> <a href="#" class="list-group-item list-group-item-action">문의글</a>
				<a href="#" class="list-group-item list-group-item-action">도움말</a>
