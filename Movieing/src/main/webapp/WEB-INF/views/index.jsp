	...
	<header class="masthead">
		<div class="container-fluid">
			...
			<div style="margin-top: 40px"></div>
				...
				<br> <br> <br> <a
					class="btn btn-primary text-uppercase js-scroll-trigger btn-lg"
					style="border-radius: 0%"
					href="<c:url value='/Movieing/Member/SignUp.mov'/>">취향 알아보러 가기
				</a>
			</div>
			...
			<div class="row text-center">
				<div class="col-md-4">
					<span class="fa-stack fa-4x"> <i
						...
						class="fas fa-video fa-stack-1x fa-inverse"></i>
					</span>
					<h4 class="service-heading">영화 정보 보기</h4>
					<p class="text-muted">
						최신 영화부터 고전 영화까지!<br /> 카테고리별로 영화를 검색할 수 있어요.<br /> VOD 가격까지
						알려드릴게요.
					</p>
				</div>
				<div class="col-md-4">
					...
					<p class="text-muted">
						어떤 영화가 있는지 궁금하신가요? <br /> 무빙은 당신의 취향을 분석해 <br /> 새로운 영화를
						추천해드립니다.
					</p>
				</div>
				<div class="col-md-4">
					<span class="fa-stack fa-4x"> <i
						class="fas fa-circle fa-stack-2x text-primary"></i> <i
						class="fas fa-home fa-stack-1x fa-inverse"></i>
					</span>
					<h4 class="service-heading">블로그</h4>
					<p class="text-muted">
						이제 취향을 아셨으니 <br /> 같은 취향의 친구들과 만나볼까요? <br /> 무빙에서는 다른 이용자분들과 소통할
						수 있어요.
					</p>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<ul class="timeline">
						<li>
							<div class="timeline-image">
								<img class="rounded-circle img-fluid"
									src="<c:url value='/resources/img/about/mov1.jpg'/>" alt="">
							</div>
							<div class="timeline-panel">
								...
								<div class="timeline-body">
									<p class="text-muted">
										이 곳에서는 전체적인 영화 목록을 보여드려요. <br /> 장르나 테마 별, 인기 순 등으로도 볼 수 있어요.
										<br /> 상세보기에서는 VOD가격까지 알려준답니다. <br />
									</p>
								</div>
							</div>
						</li>
						<li class="timeline-inverted">
							<div class="timeline-image">
								<img class="rounded-circle img-fluid"
									src="<c:url value='/resources/img/about/mov2.jpg'/>" alt="">
							</div>
							<div class="timeline-panel">
								<div class="timeline-heading">
								...
								<div class="timeline-body">
									<p class="text-muted">
										이 곳에서는 여러 영화들을 평가하고 <br /> 취향에 맞는 콘텐츠를 <br /> 추천받는 곳이예요.<br />
										평가만 하시면 <br /> 취향분석은 무빙에게 맡겨주세요! <br />
									</p>
								</div>
							</div>
						</li>
						<li>
							<div class="timeline-image">
								<img class="rounded-circle img-fluid"
									src="<c:url value='/resources/img/about/mov3.jpg'/>" alt="">
							</div>
							<div class="timeline-panel">
								<div class="timeline-heading">
								...
								<div class="timeline-body">
									<p class="text-muted">
										그 동안 본 영화들을 <br /> 기록하는 공간이예요. <br /> 자신의 기록 뿐만 아니라 <br />
										다른 사람의 기록들도 볼 수 있어서 <br /> 같은 취향의 사람들과 소통할 수 있어요.<br />
									</p>
								</div>
							</div>
						</li>
						<li class="timeline-inverted">
							<div class="timeline-image">
								<img class="rounded-circle img-fluid"
									src="<c:url value='/resources/img/about/mov4.jpg'/>" alt="">
							</div>
							<div class="timeline-panel">
								<div class="timeline-heading">
								...
								<div class="timeline-body">
									<p class="text-muted">
										혹시 영화제에 관심이 있으신가요? <br /> 무빙에서는 각종 영화제 소식까지 알려드려요. <br />
						...
						<li class="timeline-inverted">
							<div class="timeline-image">
								<br />
								<h4>
									MOVI<span style="color: #e4288c">E</span>ING
								</h4>
							</div>
						</li>
					</ul>
